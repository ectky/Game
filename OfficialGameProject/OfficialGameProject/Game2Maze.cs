...
{
    public partial class Game2Maze : Form
    {
        public Game2Maze()
        {
            InitializeComponent();
        ...
        public void doLayout()
        {
            Panel2.Top = 100;
            Panel2.Left = 0;
            Panel2.Height = ClientRectangle.Height - Panel2.Top;
            Panel2.Width = ClientRectangle.Width;
        ...
        public class Cell
        {
            ...
            public Cell getNeighbor()
            {
                ...
                if (c.Count > 0)
                {
                    Random r = new Random();
                    double x = r.Next();
                    int index = Convert.ToInt32(c.Count * x);
                    currentCell = c[index];
                }
                return currentCell;
            }
        ...
        private void Game2Maze_Load(object sender, EventArgs e)
        {
            doLayout();
        }
        ...
        private void Game2Maze_Resize(object sender, EventArgs e)
        {
            doLayout();
        }
    }
